...
RUN pacman -S sudo python jupyterhub python-pip python-pandas python-numpy python-terminado doas python-matplotlib repo git openssh rsync clang llvm lld --noconfirm
